(function(global, factory) {
  ...
  const toggleColor = (e, t) => {
      const o = getItemFromStore("Theme");
      ...
      if (l.length && window.google) {
          ...
          l.forEach((l => {
              ...
              const p = {
                      ...
                      styles: "dark" === window.config.config.Theme ? s.SnazzyCustomDark : s[n || "SnazzyCustomLight"]
                  },
              ...
              c.addListener("click", (() => {
                  ...
                  "Theme" === e && f.set("styles", "dark" === t ? s.SnazzyCustomDark : s.SnazzyCustomLight);
              }));
          }));
      }
  }
  ...
  const handleNavbarVerticalCollapsed = () => {
      const {
          ...
          setItemToStore: t,
          resize: a
      } = window.phoenix.utils, o = "body", n = ".navbar-vertical", l = ".navbar-vertical-toggle", r = ".navbar-vertical .navbar-collapse", c = ".navbar-vertical .nav-link.active", i = "click", s = "navbar.vertical.toggle", d = "navbar-vertical-collapsed", v = document.querySelector(l), m = document.querySelector(r), u = document.querySelector(c), b = e("pdIsNavbarVerticalCollapsed", !1);
      v && v.addEventListener(i, (e => {
          v.blur(), document.documentElement.classList.toggle(d), t("pdIsNavbarVerticalCollapsed", !b);
  ...
  const {
      ...
      e
          ...
          e.querySelectorAll("[data-theme-control]").forEach((e => {
              const n = t(e, "theme-control"),
                  r = a(n);
              "pdNavbarTopShape" === n && "dual-nav" === a("pdNavbarPosition") && e.setAttribute("disabled", !0);
              const i = a("pdNavbarPosition");
              if ("pdNavbarVerticalStyle" === n && ("horizontal" === i || "dual-nav" === i) && e.setAttribute("disabled", !0), "checkbox" === e.type) "Theme" === n ? ("auto" === r ? "dark" === o() : "dark" === r) && e.setAttribute("checked", !0) : r && e.setAttribute("checked", !0);
              else if ("radio" === e.type && "pdNavbarVerticalStyle" === n) "darker" === r && "darker" === e.value && e.setAttribute("checked", !0), "default" === r && "default" === e.value && e.setAttribute("checked", !0);
              else if ("radio" === e.type && "pdNavbarTopShape" === n) "slim" === r && "slim" === e.value && e.setAttribute("checked", !0), "default" === r && "default" === e.value && e.setAttribute("checked", !0);
              else if ("radio" === e.type && "pdNavbarTopStyle" === n) "darker" === r && "darker" === e.value && e.setAttribute("checked", !0), "default" === r && "default" === e.value && e.setAttribute("checked", !0);
              else if ("radio" === e.type && "Theme" === n) {
                  r === e.value && e.setAttribute("checked", !0);
              } else if ("radio" === e.type && "pdNavbarPosition" === n) {
                  r === e.value && e.setAttribute("checked", !0);
              } else {
      ...
      e.querySelectorAll('[data-theme-control = "Theme"]').forEach((e => {
          const n = t(e, "theme-control"),
              r = a(n);
  ...
  handleThemeDropdownIcon(localStorage.getItem("Theme"));
  const themeControl = () => {
      const {
          getData: e,
          getItemFromStore: t,
      ...
      initialDomSetup(n.node), n.on("click", (e => {
          ...
          if (d.data("theme-control")) {
              ...
              switch ("Theme" === l && "boolean" == typeof h && (h = h ? "dark" : "light"), config.hasOwnProperty(l) && window.config.set({
                      [l]: h
          ...
          "Theme" === e && handleThemeDropdownIcon(t);
      }));
  };
          ...
          o.forEach((o => {
              const i = t(o, "tinymce"),
                  r = merge({
                      ...
                      directionality: n("pdIsRTL") ? "rtl" : "ltr",
                      toolbar: [{
                          name: "history",
                          items: ["undo", "redo"]
                      }, {
