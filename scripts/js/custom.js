    ...
    const {
        ...
        if (o) {
            const r = t(o, "options"),
                i = echarts.init(o);
            echartSetOption(i, r, (() => ({
                color: [e("success"), e("primary"), e("danger")],
                tooltip: {
                    trigger: "item",
                    padding: [7, 10],
                    ...
                    formatter: t => `<strong>${t.data.name}:</strong> ${t.value}`
                },
                legend: {
                    show: !1
                },
